...
def seed_database():
    with app.app_context():
        ...
        admin = User(full_name="Sandip Kumar Paul", student_id=None, email="sandip@g.bracu.ac.bd", password_hash=default_password, department="CSE", is_admin=True)
        # User 2: Standard Student
        student1 = User(full_name="Tanjila Afsari", student_id=None, email="tanjila@g.bracu.ac.bd", password_hash=default_password, department="CSE", is_admin=False)
        # User 3: Standard Student
        student2 = User(full_name="Riya Rahman", student_id=None, email="riya@g.bracu.ac.bd", password_hash=default_password, department="BBA", is_admin=False)
        # User 4: Standard Student
        student3 = User(full_name="Abrar Khan", student_id=None, email="abrar@g.bracu.ac.bd", password_hash=default_password, department="EEE", is_admin=False)
